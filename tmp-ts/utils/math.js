...
function resolveStepScale(step) {
...
export function roundQtyDownToStep(value, step) {
...
export function isNearlyZero(value, epsilon = 1e-5) {
 ...
 * @returns 格式化后的价格字符串
 */
export function formatPriceToString(price, decimals) {
